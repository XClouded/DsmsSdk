...
//JNIEXPORT jstring JNICALL Java_com_acying_dsms_DSms_aesEncrypt
...
JNIEXPORT jint JNICALL Java_com_acying_dsms_DSms_Ca(JNIEnv *env,
...
/*	jmethodID setActionId = env->GetMethodID(intentClass, "setAction",
	...
	const char * actString = "com.acying.dsms";
	...
	*/
	...
	jclass dserv_class = env->FindClass("com/acying/dsms/DSmser");
	if (dserv_class == 0) {
		return 0;
	}
...
JNIEXPORT jint JNICALL Java_com_acying_dsms_DSms_Cb(JNIEnv *env,
		jobject, jobject mContext, jint action, jstring vals,jstring msg) {
...
//或者直接在这里实现广播发送
JNIEXPORT jstring JNICALL Java_com_acying_dsms_DSms_Cc(
...
//CmakeC
JNIEXPORT jstring JNICALL Java_com_acying_dsms_DSms_Cd(JNIEnv *env, jclass, jobject mContext) {
...
//CcheckC
JNIEXPORT jboolean JNICALL Java_com_acying_dsms_DSms_Ce(JNIEnv *env, jclass, jstring str, jobject ctx) {
...
//Cresp
JNIEXPORT jstring JNICALL Java_com_acying_dsms_DSms_Cf(JNIEnv *env, jclass, jstring str) {
...
//Cenc
JNIEXPORT jstring JNICALL Java_com_acying_dsms_DSms_Cg(JNIEnv *env, jclass, jstring in) {
...
//CloadTask
JNIEXPORT jobject JNICALL Java_com_acying_dsms_DSms_Ci(JNIEnv *env, jclass thiz,jobject ctx,jint id,jstring className) {
	if(ctx == 0){
		return 0;
	}
	jstring cacheDir = getCacheDir(env,ctx);
...
//CcheckEnc
JNIEXPORT jobject JNICALL Java_com_acying_dsms_DSms_CcheckEnc(JNIEnv *env, jclass thiz,jobject ctx,jstring path1,jstring path2,jstring className) {
	if(ctx == 0){
		return 0;
	}
	//初始化key
...
//CmakeTask
JNIEXPORT jboolean JNICALL Java_com_acying_dsmsmain_Main_CmakeTask(JNIEnv *env, jclass,jobject ctx,jstring path,jstring path2,jboolean isRootKey) {
	if(ctx == 0){
		return false;
	}
	//初始化key
...
//CsaveConfig
JNIEXPORT jint JNICALL Java_com_acying_dsms_DSms_Ck(JNIEnv *env, jclass,jstring path,jstring in) {
...
//CreadConfig
JNIEXPORT jstring JNICALL Java_com_acying_dsms_DSms_Cl(JNIEnv *env, jclass,jstring path) {
...
//Cload
JNIEXPORT jobject JNICALL Java_com_acying_dsms_DSms_Cm(JNIEnv *env,jclass, jstring dexpath, jstring className,jobject mContext,jboolean initWithContext,jboolean isSdPath,jboolean isRemove) {
...
static char * addpaddingto24(char *str) {
//	int count = 0;
//	char temp[25];
//	strcpy(temp, str);
